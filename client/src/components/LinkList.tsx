    ...
    <>
      ...
      {activeId !== null && (
        <div
          ...
          pointer-events-auto"
          onMouseEnter={(e: MouseEvent<HTMLDivElement>) => e.stopPropagation()} // swallow hover
        />
      )}
              ...
              >
                ...
                <label>
                  ...
                  <input
                    ...
                    onChange={(e: ChangeEvent<HTMLInputElement>) => handleEditChange('url', e.target.value)}
                ...
                <label>
                  ...
                  <input
                    ...
                    onChange={(e: ChangeEvent<HTMLInputElement>) => handleEditChange('title', e.target.value)}
                    className="border p-1 w-full mb-3 text-black"
                  />
                </label>
                <label>
                  ...
                  <input
                    ...
                    onChange={(e: ChangeEvent<HTMLInputElement>) => handleEditChange('tag', e.target.value)}
                    className="border p-1 w-full mb-3 text-black"
                  />
                </label>
